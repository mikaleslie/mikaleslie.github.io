...
- Used GIS techniques such as spatial overlays to illustrate trends in the data
...
### [Statistical Analysis of Biological Data](https://mikaleslie.github.io/mikaleslie/eemb_final.html)

- Statistical analysis report created using real-world biological data
- Statistical techniques used include analysis of normalcy variance, covariance, and use of transformations
- Practiced data visualization skills to aid in the interpretation of data and trends

![](img/stats.png){width=60%}
